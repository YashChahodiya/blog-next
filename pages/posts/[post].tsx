...
const Post = ({ data }: DataProps) => {
  return (
    <div className="grid grid-cols-1 lg:w-7/12 w-11/12 mx-auto my-6 gap-6 font-raleway lg:shadow lg:p-20 px-4">
      <Link href="/" className="text-lg  font-bold hover:text-slate-900  ">
        Go to main Page
      </Link>
      <div className="text-5xl text-slate-950 text-center font-bold my-5">
        Blog {data.id}
      </div>
...
// server side rendering Done here all
